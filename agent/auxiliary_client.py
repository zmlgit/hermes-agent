...
def resolve_vision_provider_client(
    ...
    client, final_model = _get_cached_client(
        requested, resolved_model, async_mode, api_mode=resolved_api_mode, main_runtime=runtime,
        base_url=resolved_base_url or None, api_key=resolved_api_key or None, is_vision=True,
    )
